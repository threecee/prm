define(['angular', './controllers', 'common'], function(angular, controllers) {
  ...
  mod.config(['$routeProvider', function($routeProvider) {
    $routeProvider
        ...
        .when('/importers/powerstations_components_downtimes', {templateUrl:'/assets/javascripts/classification/importers/powerstations_components_downtimes.html', controller:controllers.ShowImportersCtrl})
        .when('/importers/powerunits_components_downtimes', {templateUrl:'/assets/javascripts/classification/importers/powerunits_components_downtimes.html', controller:controllers.ShowImportersCtrl})
